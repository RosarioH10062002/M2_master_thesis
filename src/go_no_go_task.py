...
FS = 44100 
right_audio = sound.Sound(value=right_sound, sampleRate=FS)
wrong_audio = sound.Sound(value=wrong_sound, sampleRate=FS)
#--------------------------------------
...
extra_window_trial = 0.6 # 1 extra second in case they dont press something  
